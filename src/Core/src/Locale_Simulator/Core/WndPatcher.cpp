...
namespace ZQF::LS::Core
{
    ...
    static auto NtUserCreateWindowEx_Hook_Imp(DWORD& dwExStyle, PLARGE_STRING& plstrClassName, PLARGE_STRING& plstrClsVersion, PLARGE_STRING& plstrWindowName) ->void
    {
    ...
    {
        Core::NtUserCreateWindowEx_Hook_Imp(dwExStyle, plstrClassName, plstrClsVersion, plstrWindowName);
        return ZxHook::SHooker<NtUserCreateWindowEx_Hook>::FnRaw(dwExStyle, plstrClassName, plstrClsVersion, plstrWindowName, dwStyle, x, y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam, dwFlags, acbiBuffer);
    }
    ...
    {
        Core::NtUserCreateWindowEx_Hook_Imp(dwExStyle, plstrClassName, plstrClsVersion, plstrWindowName);
        return ZxHook::SHooker<NtUserCreateWindowEx_Win32u_Hook>::FnRaw(dwExStyle, plstrClassName, plstrClsVersion, plstrWindowName, dwStyle, x, y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam, dwFlags, acbiBuffer, dwUn0, dwUn1);
    }
    ...
    static auto FindNtUserCreateWindowEx() -> std::size_t
    {
        ...
        // windows7 8 8.1 find NtUserCreateWindowEx
        {
    ...
    auto WndPatcher::Install() -> bool
    {
        ...
        ZxHook::SHooker<Core::NtUserCreateWindowEx_Win32u_Hook>::Commit(fn_NtUserCreateWindowEx_va);
        return true;
    }
} // namespace ZQF::LS::Core
